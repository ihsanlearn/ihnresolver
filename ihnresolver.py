...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="ihnresolver - resolve and live-host checker (owner: iihhn)")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    # Banner
    banner = Text(f"{APP} v{VERSION}", style="bold white on blue")
    owner = Text(f"Owner: {OWNER}", style="italic")
